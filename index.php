        ...
        <div class="Header-inner">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 offset-m3">
                    ...
                    <a href=https://www.theengineroom.org/>The Engine Room</a> and the Namibian <a href=http://www.ippr.org.na/>Institute for Public Policy Research</a> built together a data model and searchable platform of petroleum exploration licenses in Namibia to power investigation and advocacy. From that experience, The Engine Room realized that the underlying data model and code can be useful for other organisations facing similar challenges — with the proper support. Through the <a href=https://www.theengineroom.org/so-the-database-or-platform-makes-information-public-now-what/>replication sprint</a> process, we built two new platforms with <a href=http://cfjmalawi.org/>Citizens for Justice</a> and <a href=https://www.oxfam.org/en/countries/malawi>Oxfam</a> in Malawi and the <a href=http://www.zela.org/>Zimbabwe Environmental Law Association</a>, targeting mineral extraction in their countries.</p>
                    <p class="light">We wish to provide support to other advocates of extractive transparency across the globe to adapt the diig.io platform for their needs. If you’re interested, <a href=https://www.theengineroom.org/contact/>get in touch with us.</a></p>
                </div>
            </div>
